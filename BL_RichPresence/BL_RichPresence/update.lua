...
local resourceName = "BL_RichPresence"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "BL_RichPresence" then
            resourceName = "BL_RichPresence (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://github.com/Linuslul13/BL_RichPresence/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://github.com/Linuslul13/BL_RichPresence/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/Linuslul13/BL_RichPresence"
            end
        end, "GET")
